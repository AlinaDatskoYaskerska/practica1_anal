...
/* of sorting by quick sort average                        */
/*                                                         */
/* Input: Command Line                                     */
...
int main(int argc, char** argv)
{
  ...
  printf("Practice number 1, section 5, Quick Sort\n");
  ...
  /* compute times */
  ret = generate_sorting_times(quicksort_avg, nombre,num_min, num_max,incr, n_perms);
